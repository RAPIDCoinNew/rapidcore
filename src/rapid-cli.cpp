...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Rapid Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  rapid-cli [options] <command> [params]  " + _("Send command to Rapid Core") + "\n" +
                  "  rapid-cli [options] help                " + _("List commands") + "\n" +
                  "  rapid-cli [options] help <command>      " + _("Get help for a command") + "\n";
