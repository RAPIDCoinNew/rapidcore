    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Rapid Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Rapid address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rapid: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Rapid Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rapid Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rapid Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rapid addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rapid addresses"));
    ...
    openAction->setStatusTip(tr("Open a rapid: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rapid Core help message to get a list with possible Rapid Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Rapid Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rapid network", "", count));
    } else {
...
LogPrintf("myfix bitcoingui.cpp setnumblocks blocksource:%d\n",blockSource);
    switch (blockSource) {
...
{
    QString strTitle = tr("Rapid Core"); // default title
