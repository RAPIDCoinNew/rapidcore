...
{
if(fReindex)LogPrintf("myfix clientmodel.cpp getblocksource fReindex\n");
if(fImporting)LogPrintf("myfix clientmodel.cpp getblocksource fImport\n");
LogPrintf("myfix clientmodel.cpp getblocksource getnumconnections:%d\n",getNumConnections());
    if (fReindex)
