    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Rapid Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Rapid Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  rapid-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Rapid in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RPD, 0.1 RPD, 1 RPD and 10 RPD -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://rapidpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://rapidpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Rapid Core is shutting down...") + "<br /><br />" +
