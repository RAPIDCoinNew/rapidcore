    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RPD-light"), QVariant("light"));
    ui->theme->addItem(QString("RPD-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("RPD-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RPD-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RPD-traditional"), QVariant("trad"));
