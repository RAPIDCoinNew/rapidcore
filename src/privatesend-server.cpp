...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Rapid related functionality
...
/*
    ...
    allow endless transaction that would bloat Rapid and make it unusable. To
