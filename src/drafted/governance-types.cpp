...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RapidNetwork") type = RapidNetwork;
    if(strType == "RapidNetworkVariable") type = RapidNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RapidNetwork) s = "RapidNetwork";
    if(type == RapidNetworkVariable) s = "RapidNetworkVariable";
