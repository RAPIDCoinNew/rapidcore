 ...
 *
 *   // network
 *   CRapidNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.rapid.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CRapidNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: RapidNetwork
// //   -- signature requirements : Key1(User)
// class CRapidNetworkVariable : public CGovernanceObject
// {
// private:
