...
#define BOOST_TEST_MODULE Rapid Test Suite

#include "test_rapid.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_rapid_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
