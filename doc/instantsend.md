...
This mechanism has been integrated into Bitcore-Node-Rapid which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rapidpay/insight-api-rapid#web-socket-api](https://github.com/rapidpay/insight-api-rapid#web-socket-api)
* API: [https://github.com/rapidpay/insight-api-rapid#instantsend-transactions](https://github.com/rapidpay/insight-api-rapid#instantsend-transactions)
...
By default, the Rapid Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Rapid Core daemon:
