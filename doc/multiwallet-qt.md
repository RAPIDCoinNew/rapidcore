...
Only requiring some minor changes is rapid.cpp.
...
Changes to rapid.cpp
----------------------
rapid.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
